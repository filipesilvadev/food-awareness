...
class RWMB_Core {
	...
	public function plugin_links( $links ) {
		$links[] = '<a href="https://metabox.io/docs/">' . esc_html__( 'Documentation', 'docent-pro-core' ) . '</a>';
		$links[] = '<a href="https://metabox.io/plugins/">' . esc_html__( 'Extensions', 'docent-pro-core' ) . '</a>';
		return $links;
	}
