...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php esc_html_e( 'Product', 'docent-pro' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'docent-pro' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'docent-pro' ); ?></th>
			</tr>
		</thead>
		<tbody>
		...
		<?php if ( $order->needs_payment() ) : ?>
			<ul class="wc_payment_methods payment_methods methods">
				...
				if ( ! empty( $available_gateways ) ) {
					...
					echo '<li class="woocommerce-notice woocommerce-notice--info woocommerce-info">' . apply_filters( 'woocommerce_no_available_payment_methods_message', esc_html__( 'Sorry, it seems that there are no available payment methods for your location. Please contact us if you require assistance or wish to make alternate arrangements.', 'docent-pro' ) ) . '</li>'; // @codingStandardsIgnoreLine
				}
				?>
			</ul>
		<?php endif; ?>
