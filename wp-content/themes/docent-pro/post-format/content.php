...
<?php endif; ?>
            ...
            <div class="single-blog-info">
                <?php if ( get_theme_mod( 'blog_date_single', true ) ) { ?>
                    <div class="blog-date-wrapper">
                        ...
                        <a href="<?php the_permalink(); ?>"><time datetime="<?php echo get_the_date('M j, Y') ?>"><?php echo date_i18n("M j, Y", strtotime($the_date)); ?></time></a>
                    </div>
                <?php } ?>
                    ...
                    <ul class="blog-post-meta clearfix"> 
                        <?php if ( get_theme_mod( 'blog_author_single', true ) ): ?>
                            <li class="meta-author">
                                <span class="img-author">
                                    <a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) )); ?>"> <?php esc_html_e('By. ', 'docent-pro'); ?><?php echo wp_kses_post(get_the_author_meta('display_name')); ?></a>
                                </span>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if ( get_theme_mod( 'blog_category_single', false ) ): ?> 
                            <li class="post-category">
                                <?php echo '<span>Category. </span>'.wp_kses_post(get_the_category_list(', ')); ?>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if ( get_theme_mod( 'blog_hit_single', true ) ) { ?>
                            <li class="meta-view-count">      
                                ...
                                ?>
                                <span><?php echo 'View Count. '. esc_attr( $docent_pro_visitor_count ); ?></span>
                            </li>
                        <?php } ?> 

                        <?php if ( get_theme_mod( 'blog_tags_single', true ) ) { ?>
                            <?php echo wp_kses_post(get_the_tag_list('<li class="meta-tag-count">Tag. ',', ','</li>')); ?>
                        <?php } ?>

                        <?php if ( get_theme_mod( 'blog_comment_single', false ) ) { ?>
                            <li>
                                <span><?php comments_number( '0', '1', '%' ); ?><?php esc_html_e(' Comments', 'docent-pro') ?></span>
                            </li>
                        <?php } ?> 
    ...
    <div class="docent-blog-title clearfix"> 
                ...
                <?php if ( get_theme_mod( 'blog_author', false ) ): ?>
                    <li class="meta-author">
                        <a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) )); ?>">
                            <?php esc_html_e('By ', 'docent-pro') ?><?php echo wp_kses_post(get_the_author_meta('display_name')); ?>  
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php endif; ?>
                 ...
                 <?php if ( get_theme_mod( 'en_blog_date', true ) ): ?>
                    <li>
                        <div class="blog-date-wrapper">
                            <?php $the_date = get_the_date(); ?>
                            <a href="<?php the_permalink(); ?>"><time datetime="<?php echo get_the_date('M j') ?>"><?php echo date_i18n("M j", strtotime($the_date)); ?></time></a>
                        </div>
                    </li>
                <?php endif; ?>
        ...
        <?php endif; ?>
        <?php the_title( '<h2 class="content-item-title A"><a href="'.get_the_permalink().'">', '</a></h2>' ); ?>
        <?php } ?>
